...
class PredictionPipelineConfig:
    ...
    prediction_file_name: str="perdiction_file.csv"
...
class PredictionPipeline:
    ...
    def get_predicted_dataframe(self,input_dataframe_path: pd.DataFrame):
        try:
            ...
            input_dataframe=input_dataframe.drop(columns="Unammed: 0") if "Unammed: 0" in input_dataframe.columns else input_dataframe
